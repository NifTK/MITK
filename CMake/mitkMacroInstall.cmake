...
macro(_fixup_target)
  ...
  install(CODE "
    ...
    set(GLOBBED_CTK_DESIGNER_PLUGINS )
    if(CMAKE_SHARED_MODULE_SUFFIX AND NOT CMAKE_SHARED_MODULE_SUFFIX STREQUAL CMAKE_SHARED_LIBRARY_SUFFIX)
      file(GLOB_RECURSE GLOBBED_CTK_DESIGNER_PLUGINS \"\${CMAKE_INSTALL_PREFIX}/${${_target_location}_qt_plugins_install_dir}/plugins/designer/*${CMAKE_SHARED_MODULE_SUFFIX}\")
    endif()

    set(PLUGINS )
    foreach(_plugin ${_install_PLUGINS} \${GLOBBED_QT_PLUGINS} \${GLOBBED_CTK_DESIGNER_PLUGINS} \${GLOBBED_PLUGINS})
