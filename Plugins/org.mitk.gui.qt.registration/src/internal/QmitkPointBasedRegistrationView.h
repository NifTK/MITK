...
#include <mitkRenderWindowPartListener.h>
...
class REGISTRATION_EXPORT QmitkPointBasedRegistrationView : public QmitkAbstractView, public mitk::IRenderWindowPartListener
{
