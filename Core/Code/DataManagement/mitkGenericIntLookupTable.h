...
#ifndef MITKGENERICINTLOOKUPTABLE_H_HEADER_INCLUDED_C1061CEE
#define MITKGENERICINTLOOKUPTABLE_H_HEADER_INCLUDED_C1061CEE
...
/**
 * @brief Template class for generating int-tagged lookup-tables
 *
...
class GenericIntLookupTable
{
  public:
    ...
    typedef GenericIntLookupTable        Self;

    GenericIntLookupTable() {}
    virtual ~GenericIntLookupTable()
    {
    }

    virtual const char *GetNameOfClass() const
    {
      return "GenericIntLookupTable";
    }
...
/**
* Generates a specialized subclass of mitk::GenericIntLookupTable.
* This way, GetNameOfClass() returns the value provided by LookupTableName.
* Please see mitkProperties.h for examples.
* @param LookupTableName the name of the instantiation of GenericIntLookupTable
* @param Type the value type of the GenericIntLookupTable
*/
#define mitkSpecializeGenericIntLookupTable(LookupTableName,Type)  \
class MITK_CORE_EXPORT LookupTableName: public GenericIntLookupTable< Type >    \
{                                                               \
public:                                                         \
typedef LookupTableName Self;                                   \
  typedef GenericIntLookupTable< Type >   Superclass;              \
  virtual const char *GetNameOfClass() const                    \
...
*/
#define mitkSpecializeGenericIntLookupTableOperator(LookupTableName)              \
